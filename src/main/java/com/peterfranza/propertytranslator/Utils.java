...
public class Utils {
	...
	public static String getPackageNameFor(File inputRoot, String filename, Log logger) throws FileNotFoundException, IOException {
		...
		logger.warn("Package not found for " + filename + ", if this is a java property create a package-info.java sibling in same directory");
